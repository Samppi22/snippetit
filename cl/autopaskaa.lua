...
--ETU VASEN--
RegisterNetEvent('leftf')
AddEventHandler('leftf',function() 
	local player = GetPlayerPed(-1)
			if controlsave_bool == true then
				vehicle = saveVehicle
			else
...
--ETU oikea--
RegisterNetEvent('rightf')
AddEventHandler('rightf',function() 
	local player = GetPlayerPed(-1)
			if controlsave_bool == true then
				vehicle = saveVehicle
			else
...
--TAKA VASEN--
RegisterNetEvent('leftb')
AddEventHandler('leftb',function() 
	local player = GetPlayerPed(-1)
			if controlsave_bool == true then
				vehicle = saveVehicle
			else
...
--TAKA OIKEA--
RegisterNetEvent('rightb')
AddEventHandler('rightb',function() 
	local player = GetPlayerPed(-1)
			if controlsave_bool == true then
				vehicle = saveVehicle
			else
